...
interface
USES
     Classes, SysUtils,Command, MeterClass, Meterelement, DSSClass, Arraydef, ucomplex, utilities;
...
implementation
  USES
    ...
    ParserDel, DSSClassDefs, DSSGlobals, Circuit, CktElement,Transformer, PCElement,ucmatrix, mathUtil, PointerList,  Dynamics, PstCalc;
  CONST
    SEQUENCEMASK = 16;
    MAGNITUDEMASK = 32;
    POSSEQONLYMASK = 64;

...
uses
  Classes, SysUtils,DSSClass, PCClass,PCElement, ucmatrix, ucomplex, PointerLIst, CktElement, CktTree;
TYPE
// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
...
implementation
 USES  ParserDel, Circuit, DSSClassDefs, DSSGlobals, Utilities, Command, Energymeter,PDElement;
...
Begin
     ...
     SequenceList := TNPointerList.Create(50);
     ShuntList := TNPointerList.Create(50);

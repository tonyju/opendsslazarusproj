...
uses
  Classes, SysUtils,ArrayDef, StackDef, PointerList, CktElement;
Type
  ...
  TAdjArray = array of TList;
   ...
   TCktTreeNode = class(TObject)
     private
       ...
       FChildBranches:TNPointerList;  // List of CktTreeNode pointers
     ...
     protected
       ...
       FShuntObjects :TNPointerList;  // Generic objects attached to the tree at this node
...
Begin
     ...
     Else
        LexicalLevel := 0;
     FChildBranches   := TNPointerList.Create(2);
     FShuntObjects    := TNPointerList.Create(1);
     FromBusReference := 0;
...
begin
   EndnodeList := TNPointerList.Create(10);
   NumEnds := 0;
   EndBuses := Nil;
end;

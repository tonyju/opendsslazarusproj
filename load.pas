...
uses
  Classes, SysUtils,DSSClass, PCClass, PCElement, ucmatrix, ucomplex, LoadShape, GrowthShape, Spectrum, ArrayDef;
TYPE
// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
...
implementation
USES  ParserDel, Circuit, DSSClassDefs, DSSGlobals, Dynamics, Command, Math, MathUtil, Utilities;

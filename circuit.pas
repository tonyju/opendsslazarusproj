...
uses
  Classes, SysUtils,Solution, ArrayDef, HashList, PointerList, CktElement,
    ...
    END;
     ...
     TDSSCircuit = CLASS(TNamedObject)
      ...
      Public
          ...
          ShuntCapacitors,
          Feeders,
          SwtControls        :PointerList.TNPointerList;
...
implementation
USES
     PDElement, CktElementClass,ParserDel,  DSSClassDefs, DSSGlobals, Dynamics,Line,Transformer, Vsource,Utilities;
...
BEGIN
     ...
     Faults          := TNPointerList.Create(2);
     CktElements     := TNPointerList.Create(1000);
     PDElements      := TNPointerList.Create(1000);
     PCElements      := TNPointerList.Create(1000);
     DSSControls     := TNPointerList.Create(10);
     Sources         := TNPointerList.Create(10);
     MeterElements   := TNPointerList.Create(20);
     Monitors        := TNPointerList.Create(20);
     EnergyMeters    := TNPointerList.Create(5);
     Sensors         := TNPointerList.Create(5);
     Generators      := TNPointerList.Create(5);
     StorageElements := TNPointerList.Create(5);
     PVSystems       := TNPointerList.Create(5);
     Feeders         := TNPointerList.Create(10);
     Substations     := TNPointerList.Create(5);
     Transformers    := TNPointerList.Create(10);
     CapControls     := TNPointerList.Create(10);
     SwtControls     := TNPointerList.Create(50);
     RegControls     := TNPointerList.Create(5);
     Lines           := TNPointerList.Create(1000);
     Loads           := TNPointerList.Create(1000);
     ShuntCapacitors := TNPointerList.Create(20);

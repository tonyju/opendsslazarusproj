...
uses
  Classes, SysUtils,pointerlist,command,arraydef,hashlist;
type
...
implementation
     USES dssglobals, DSSObject, ParserDel, CktElement;
     {--------------------------------------------------------------}
     ...
     BEGIN
         Inherited Create;
         ElementList := TNPointerList.Create(20);  // Init size and increment
         PropertyName := nil;
         PropertyHelp := Nil;
         PropertyIdxMap  := Nil;

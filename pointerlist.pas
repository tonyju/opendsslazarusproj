...
uses
  Classes, SysUtils,Arraydef;

TYPE
   TNPointerList = class(TObject)
   private
      NumInList:Integer;
...
constructor TNPointerList.Create(Size:Integer);
//-------------------------------------------------------------------------
BEGIN
   Inherited Create;
...
//-------------------------------------------------------------------------
destructor TNPointerList.Destroy;
BEGIN
...
//-------------------------------------------------------------------------
Function TNPointerList.Add(p:Pointer):Integer;
BEGIN
    Inc(NumInList);
...
//-------------------------------------------------------------------------
Procedure TNPointerList.Set_New(value:Pointer);
BEGIN
    Add(Value);
END;

//-------------------------------------------------------------------------
Function TNPointerList.Get_Active:Pointer;
BEGIN
...
//-------------------------------------------------------------------------
Function TNPointerList.Get_First:Pointer;
BEGIN
...
//-------------------------------------------------------------------------
Function TNPointerList.Get_Next:Pointer;
BEGIN
    IF NumInList>0 THEN BEGIN
       Inc(ActiveItem);
...
//-------------------------------------------------------------------------
Function TNPointerList.Get(i:Integer):Pointer;
BEGIN

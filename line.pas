...
TYPE
   ...
   TLineObj = class(TPDElement)
      Private
        ...
        function FetchLineGeometryObj: TLineGeometryObj;
      ...
      Public     // Moved to make values available to the COM interface
        ...
        Property lineGeometryobj:TLineGeometryObj read FetchLineGeometryObj;
   end;
...
USES  ParserDel,  DSSClassDefs, DSSGlobals, ArrayDef,
...
function TLineObj.Fetchlinegeometryobj:TlinegeometryObj;
begin
Result := FLineGeometryObj;
end;

...
uses
  Classes, SysUtils,DSSClass, PCClass,PCElement, ucmatrix, ucomplex, Spectrum, Loadshape;
...
USES  ParserDel, Circuit, DSSClassDefs, DSSGlobals, Dynamics, Utilities, Command;

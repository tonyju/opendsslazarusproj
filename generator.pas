...
uses
  Classes, SysUtils,GeneratorVars, DSSClass,  PCClass, PCElement, ucmatrix, ucomplex, LoadShape, GrowthShape, Spectrum, ArrayDef, Dynamics;
//generator user model is not supported
...
implementation
USES  ParserDel, Circuit, Command, Math, MathUtil, DSSClassDefs, DSSGlobals, Utilities;

...
Begin
   ...
   Else Begin
      ...
      Try
        ...
        End;
      Except
          On E: Exception Do writeln('node buffer too small!');//DSSMessageDlg('Node Buffer Too Small: ' + E.Message, TRUE);
      End;
...
BEGIN
   ...
   EXCEPT
       On E: Exception Do writeln('Vector Buffer in ParseAsVector Probably Too Small');//DSSMessageDlg('Vector Buffer in ParseAsVector Probably Too Small: ' + E.Message, TRUE);
   END;
...
BEGIN
  ...
  TRY
   ...
   EXCEPT
       On E: Exception Do writeln('Matrix Buffer in ParseAsMatrix Probably Too Small:');//DSSMessageDlg('Matrix Buffer in ParseAsMatrix Probably Too Small: ' + E.Message, TRUE);
   END;
...
BEGIN
  ...
  TRY
   ...
   EXCEPT
       On E: Exception Do writeln('Matrix Buffer in ParseAsSymMatrix Probably Too Small: ');//DSSMessageDlg('Matrix Buffer in ParseAsSymMatrix Probably Too Small: ' + E.Message, TRUE);
   END;

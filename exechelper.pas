...
USES Command, ArrayDef, ParserDel, DSSClassDefs, DSSGlobals,
     Circuit, Monitor, DSSClass, DSSObject, Utilities, Solution,
     EnergyMeter, Generator, LoadShape, Load, PCElement,   CktElement,
     uComplex,  mathutil,  Bus,  SolutionAlgs,ExecCommands, Executive, Dynamics,
     Capacitor, Reactor, Line, Lineunits, Math, CktElementClass, Sensor, NamedObject,
...
VAR
   ...
   Params: Integer;
Begin
writeln('regularexpressionscore');
End;

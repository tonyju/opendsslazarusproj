...
uses
  Classes, SysUtils,Command, ControlClass, ControlElem, CktElement, DSSClass, Arraydef, ucomplex,
     utilities, PointerList;
...
// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
   TGenDispatcherObj = class(TControlElem)
     private
            ...
            FGenPointerList:PointerList.TNPointerList;
...
USES
    ...
    ParserDel, DSSClassDefs, DSSGlobals, Circuit,  Generator, uCmatrix, MathUtil, Math;
...
Begin
     ...
     FWeights   := Nil;
     FGenPointerList := PointerList.TNPointerList.Create(20);  // Default size and increment
     FListSize   := 0;
     FkWLimit    := 8000.0;
     FkWBand     := 100.0;
     TotalWeight := 1.0;

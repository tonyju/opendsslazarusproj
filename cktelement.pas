...
uses
  Classes, SysUtils,ucomplex,ucmatrix,arraydef,terminal,dssobject,dssclass,pointerlist;
type
TDSSCktElement = class(TDSSObject)
 ...
 public
   ...
   ControlElementList: TNPointerList; //Pointer to control for this device
...
USES DSSGlobals, Utilities, Math;
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Begin
     ...
     ControlElementList := PointerList.TNPointerList.Create(1);

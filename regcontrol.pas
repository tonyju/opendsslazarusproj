...
uses
  Classes, SysUtils,Command, ControlClass, ControlElem, DSSClass, Arraydef, ucomplex,Transformer, utilities;
...
USES
    ...
    ParserDel, DSSClassDefs, DSSGlobals, Circuit, CktElement,uCmatrix, MathUtil, Math;

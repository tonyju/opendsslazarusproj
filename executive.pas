...
uses
  Classes, SysUtils,PointerList, Command;
...
USES ExecCommands, ExecOptions, DSSClassDefs, DSSGlobals, ParserDel, Utilities, Solution, DSSClass;
...
Begin
     ...
     Circuits := TNPointerList.Create(2);   // default buffer for 2 active circuits
     NumCircuits := 0;
     ActiveCircuit := nil;
